...
public sealed class EcommerceApplicationProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public EcommerceApplicationProblemDetailsFactory(ApiBehaviorOptions options)
    {
        _options = options;
    }
    ...
    private void ApplyProblemDetailsDefault(HttpContext httpContext,
