...
namespace Ecommerce.Catalog.Tests.ArchTests.Application;

public sealed class ApplicationArchTests
{
    private readonly Assembly _assembly = typeof(ApplicationReference).Assembly;
    ...
    [Fact]
    public void Application_Should_ContainItsDependencyInjectionPublicAndStatic()
    {
        TestResult result = Types
